   ...
   public class AddNewCustomerPageTest:BasePage
    {
        ...
        public void VerfiyAddNewCustomerPageTest()
        {
            ...
            string ActualAddNewCustomerPageTitle = ANCp.VerifyAddNewCustomerPageURL();
            string ActualAddNewCustomerPageUrl = ANCp.VerifyAddNewCustomerPageURL();
            Assert.AreEqual("Guru99 Bank Customer Registration Page", ActualAddNewCustomerPageTitle);
